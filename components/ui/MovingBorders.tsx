...
export const MovingBorder = ({
  ...
  const x = useTransform(
    progress,
    (val) => (pathRef.current as unknown as SVGGeometryElement)?.getPointAtLength(val).x
  );
  const y = useTransform(
    progress,
    (val) => (pathRef.current as unknown as SVGGeometryElement)?.getPointAtLength(val).y
  );
